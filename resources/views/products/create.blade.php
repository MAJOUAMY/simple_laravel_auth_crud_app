...
@section('main')
<form action="create" enctype="multipart/form-data" method="post" class="max-w-md mx-auto bg-white p-8 mt-10 rounded shadow-md">
    @csrf
    ...
    <div class="mb-4">
        ...
        <textarea id="body" name="body" class="w-full p-2 border border-gray-300 rounded" required></textarea>
    </div>
